...
<body>
    <form id="form1" runat="server">
        <div class="auto-style2">
            ...
            <br />
            <br />
            <asp:Button ID="btn_Search" runat="server" Text="Search" OnClick="btn_Search_Click" CssClass="button6" style="background-color:#668fff" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_Cancel" runat="server" Text="Cancel" OnClick="btn_Cancel_Click" class="button6"  />
