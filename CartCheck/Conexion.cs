...
namespace CartCheck
{
    internal class Conexion
    {
        ...
        Con1 = new SqlConnection(@"Data Source=MEX-ERP-003;Initial Catalog=COLLECT_TRAIN;User ID=sa;Password=Password1;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
