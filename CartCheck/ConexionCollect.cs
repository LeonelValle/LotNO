...
namespace CartCheck
{
    internal class ConexionCollect
    {
        private SqlConnection Con; // Obj Conexion

        public ConexionCollect() =>
        ...
        Con1 = new SqlConnection(@"Data Source=MEX-ERP-003;Initial Catalog=COLLECT_MAIN;User ID=lotusr;Password=Mexmei11;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
